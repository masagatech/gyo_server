...
parent.getParentDetails = function getParentDetails(req, res, done) {
    db.callProcedure("select " + globals.schema("funget_parentdetails") + "($1,$2::json);", ['prnts', req.body], function(data) {
